          ...
          render={({ handleSubmit }) => (
            <div>
              ...
              <BigInputBox>
                <Field
                  name="age"
                  defaultValue={String(current_profile.age) || ""}
                  label="Age *"
                  component={InputProfile}
                />
              </BigInputBox>
              <FormBox>
                <SmallInputBox>
                  <Field
                    name="feet"
                    defaultValue={String(current_profile.feet) || ""}
                    placeholder="Feet"
                    label="Feet *"
                    component={InputProfile}
                  />
                ...
                <SmallInputBox>
                  <Field
                    name="inches"
                    defaultValue={String(current_profile.inches) || ""}
                    placeholder="Inches"
                    label="Inches"
                    component={InputProfile}
                  />
              ...
              <BigInputBox>
                <Field
                  name="weight"
                  defaultValue={String(current_profile.weight) || ""}
                  label="Weight *"
                  placeholder="Weight *"
                  component={InputProfile}
                />
              ...
              <FormBox>
                <SmallInputBox>
                  <Field
                    name="throws"
                    defaultValue={
                      String(current_profile.throws_hand) || ""
                    }
                    placeholder="Throws *"
                    label="Throws *"
                    component={InputProfile}
                ...
                <SmallInputBox>
                  <Field
                    name="bats"
                    defaultValue={String(current_profile.bats_hand) || ""}
                    placeholder="Bats *"
                    label="Bats *"
                    component={InputProfile}
                  />
              ...
              <BigInputBox>
                <Field
                  name="school"
                  defaultValue={String(current_profile.school) || ""}
                  label="School *"
                  component={InputProfile}
                />
              </BigInputBox>
              <BigInputBox>
                <Field
                  name="schoolYear"
                  defaultValue={String(current_profile.school_year) || ""}
                  label="School Year "
                  component={InputProfile}
                />
              </BigInputBox>
              ...
              <TextAreaBox>
                <Field
                  name="bio"
                  defaultValue={String(current_profile.biography) || ""}
